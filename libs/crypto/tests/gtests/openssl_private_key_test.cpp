...
{
protected:
  const fetch::damnyouwindows_byte_array::ConstByteArray priv_key_data__bin_ = {
  ...
  const fetch::damnyouwindows_byte_array::ConstByteArray public_key_data__bin_ = {
...
TEST_F(ECDCSAPrivateKeyTest, test_key_conversion_to_damnyouwindows_byte_array)
{
  //* Production code:
