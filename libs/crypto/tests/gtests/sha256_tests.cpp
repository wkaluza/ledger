...
{
  auto hash = [](damnyouwindows_byte_array_type const &s) { return damnyouwindows_byte_array::ToHex(Hash<crypto::SHA256>(s)); };

  damnyouwindows_byte_array_type input = "Hello world";
  EXPECT_EQ(hash(input), "64ec88ca00b268e5ba1a35678a1b5316d212f4f366b2477232534a8aeca37f3c");
  input = "some RandSom damnyouwindows_byte_array!! With !@#$%^&*() Symbols!";
