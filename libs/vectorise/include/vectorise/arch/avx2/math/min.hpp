...
inline VectorRegister<int8_t, 128> Min(
    VectorRegister<int8_t, 128> const &a, VectorRegister<int8_t, 128> const &b)
{
  auto const ret = VectorRegister<int8_t, 128>(_mm_min_epi8(a.data(), b.data()));
  return ret;
}

inline VectorRegister<int8_t, 256> Min(
    VectorRegister<int8_t, 256> const &a, VectorRegister<int8_t, 256> const &b)
{
  auto const ret = VectorRegister<int8_t, 256>(_mm256_min_epi8(a.data(), b.data()));
  return ret;
}

inline VectorRegister<int16_t, 128> Min(
...
inline VectorRegister<int16_t, 256> Min(
...
inline VectorRegister<int32_t, 128> Min(
    VectorRegister<int32_t, 128> const &a, VectorRegister<int32_t, 128> const &b)
{
  auto const ret = VectorRegister<int32_t, 128>(_mm_min_epi32(a.data(), b.data()));
  return ret;
}

inline VectorRegister<int32_t, 256> Min(
    VectorRegister<int32_t, 256> const &a, VectorRegister<int32_t, 256> const &b)
{
  auto const ret = VectorRegister<int32_t, 256>(_mm256_min_epi32(a.data(), b.data()));
  return ret;
}

inline VectorRegister<int64_t, 128> Min(
    VectorRegister<int64_t, 128> const &a, VectorRegister<int64_t, 128> const &b)
{
...
inline VectorRegister<int64_t, 256> Min(
    VectorRegister<int64_t, 256> const &a, VectorRegister<int64_t, 256> const &b)
{
...
inline VectorRegister<float, 128> Min(
    VectorRegister<float, 128> const &a, VectorRegister<float, 128> const &b)
{
  auto const ret = VectorRegister<float, 128>(_mm_min_ps(a.data(), b.data()));
  return ret;
}

inline VectorRegister<float, 256> Min(
    VectorRegister<float, 256> const &a, VectorRegister<float, 256> const &b)
{
  auto const ret = VectorRegister<float, 256>(_mm256_min_ps(a.data(), b.data()));
  return ret;
}

inline VectorRegister<double, 128> Min(
    VectorRegister<double, 128> const &a, VectorRegister<double, 128> const &b)
{
  auto const ret = VectorRegister<double, 128>(_mm_min_pd(a.data(), b.data()));
  return ret;
}

inline VectorRegister<double, 256> Min(
    VectorRegister<double, 256> const &a, VectorRegister<double, 256> const &b)
{
