...
inline VectorRegister<int8_t, 128> operator*(
...
inline VectorRegister<int8_t, 256> operator*(
...
inline bool all_less_than(
    VectorRegister<int8_t, 128> const &x, VectorRegister<int8_t, 128> const &y)
{
  __m128i r = (x < y).data();
...
inline bool all_less_than(
    VectorRegister<int8_t, 256> const &x, VectorRegister<int8_t, 256> const &y)
{
  __m256i r    = (x < y).data();
