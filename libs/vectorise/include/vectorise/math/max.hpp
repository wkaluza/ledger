...
inline VectorRegister<float, 128> damnyouwindows_max(VectorRegister<float, 128> const &a,
                                      VectorRegister<float, 128> const &b)
{
  return VectorRegister<float, 128>(_mm_max_ps(a.data(), b.data()));
}

inline VectorRegister<double, 128> damnyouwindows_(VectorRegister<double, 128> const &a,
