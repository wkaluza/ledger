...
VM::VM(Module *module)
{
  ...
  AddOpcodeInfo(
      Opcodes::Duplicate,
      "Duplicate",
      [](VM *vm) { vm->Handler__Duplicate(); },
      OpcodeCharges::CHARGE_DUPLICATE);
  AddOpcodeInfo(
      Opcodes::DuplicateInsert,
      "DuplicateInsert",
  ...
  AddOpcodeInfo(
      Opcodes::Discard,
      "Discard",
      [](VM *vm) { vm->Handler__Discard(); },
      OpcodeCharges::CHARGE_DISCARD);
  AddOpcodeInfo(
      Opcodes::Destruct,
      "Destruct",
      [](VM *vm) { vm->Handler__Destruct(); },
      OpcodeCharges::CHARGE_DESTRUCT);
  AddOpcodeInfo(
      Opcodes::Break, "Break", [](VM *vm) { vm->Handler__Break(); }, OpcodeCharges::CHARGE_BREAK);
  AddOpcodeInfo(
      Opcodes::Continue,
      "Continue",
      [](VM *vm) { vm->Handler__Continue(); },
      OpcodeCharges::CHARGE_CONTINUE);
  AddOpcodeInfo(
      Opcodes::Jump, "Jump", [](VM *vm) { vm->Handler__Jump(); }, OpcodeCharges::CHARGE_JUMP);
  AddOpcodeInfo(
      Opcodes::JumpIfFalse,
      "JumpIfFalse",
      [](VM *vm) { vm->Handler__JumpIfFalse(); },
      OpcodeCharges::CHARGE_JUMP_IF_FALSE);
  AddOpcodeInfo(
      Opcodes::JumpIfTrue,
      "JumpIfTrue",
      [](VM *vm) { vm->Handler__JumpIfTrue(); },
      OpcodeCharges::CHARGE_JUMP_IF_TRUE);
  AddOpcodeInfo(
      Opcodes::Return,
      "Return",
      [](VM *vm) { vm->Handler__Return(); },
  ...
  AddOpcodeInfo(
      ...
      "LocalVariablePrimitiveInplaceAdd",
  ...
  AddOpcodeInfo(
      ...
      "LocalVariableObjectInplaceRightAdd",
  ...
  AddOpcodeInfo(
      ...
      "LocalVariableObjectInplaceSubtract",
  ...
  AddOpcodeInfo(
      ...
      "LocalVariableObjectInplaceMultiply",
  ...
  AddOpcodeInfo(
      ...
      "ObjectDivide",
      [](VM *vm) { vm->Handler__ObjectDivide(); },
  ...
  AddOpcodeInfo(
      ...
      "LocalVariablePrimitiveInplaceDivide",
  ...
  AddOpcodeInfo(
      ...
      "LocalVariableObjectInplaceDivide",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariablePrimitiveInplaceAdd",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariableObjectInplaceAdd",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariableObjectInplaceRightAdd",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariableObjectInplaceSubtract",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariableObjectInplaceMultiply",
  ...
  AddOpcodeInfo(
      ...
      "MemberVariableObjectInplaceDivide",
  ...
  AddOpcodeInfo(
      Opcodes::PushSelf,
      "PushSelf",
      [](VM *vm) { vm->Handler__PushSelf(); },
      OpcodeCharges::CHARGE_PUSH_SELF);
  AddOpcodeInfo(
      Opcodes::InvokeUserDefinedConstructor,
      "InvokeUserDefinedConstructor",
      [](VM *vm) { vm->Handler__InvokeUserDefinedConstructor(); },
      OpcodeCharges::CHARGE_INVOKE_USER_DEFINED_CONSTRUCTOR);
  AddOpcodeInfo(
      Opcodes::InvokeUserDefinedMemberFunction,
      "InvokeUserDefinedMemberFunction",
...
void VM::UpdateCharges(std::unordered_map<std::string, ChargeAmount> const &opcode_static_charges)
{
  for (auto const &entry : opcode_static_charges)
  {
    ...
    auto it = std::find_if(
        opcode_info_array_.begin(), opcode_info_array_.end(), [&unique_name](OpcodeInfo &info) {
          return info.unique_name == unique_name;
        });
