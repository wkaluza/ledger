...
private:
  ...
  {
    analyser_.CreateTemplateInstantiationType(
        type_index, template_type_index, template_parameter_type_index_array);
  }
  ...
  void CreateStaticMemberFunction(
      ...
      ChargeAmount          static_charge)
  {
    analyser_.CreateStaticMemberFunction(
        type_index,
        function_name,
  ...
  void CreateMemberFunction(
      ...
      ChargeAmount          static_charge)
  {
    analyser_.CreateMemberFunction(
        type_index,
        function_name,
        parameter_type_index_array,
        return_type_index,
