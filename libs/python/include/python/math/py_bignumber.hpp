...
void BuildBigUnsigned(pybind11::module &module)
{
  ...
  py::class_<BigUnsigned, damnyouwindows_byte_array::ConstByteArray>(module, "BigUnsigned")
      .def(py::init<>())
      ...
      //    .def(py::self = damnyouwindows_byte_array::ConstByteArray() )
      //    .def(py::self = damnyouwindows_byte_array::ByteArray() )
      //    .def(py::self = damnyouwindows_byte_array::ConstByteArray() )
      .def(py::self < fetch::math::BigUnsigned())
      .def(py::self > fetch::math::BigUnsigned())
