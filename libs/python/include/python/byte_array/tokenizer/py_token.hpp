...
void BuildToken(pybind11::module &module)
{
  ...
  py::class_<Token, fetch::damnyouwindows_byte_array::ConstByteArray>(module, "Token")
      .def(py::init<>())
      .def(py::init<const char *>())
      .def(py::init<const std::string &>())
      .def(py::init<const fetch::damnyouwindows_byte_array::ConstByteArray &>())
      .def(py::init<const fetch::damnyouwindows_byte_array::ConstByteArray &, const std::size_t &,
                    const std::size_t &>())
