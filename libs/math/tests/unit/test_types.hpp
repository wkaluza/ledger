...
using FixedPointTypes = ::testing::
    Types<fetch::fixed_point::fp32_t, fetch::fixed_point::fp64_t, fetch::fixed_point::fp128_t>;
...
using IntAndFloatingTypes = ::testing::Types<
    int32_t,
    int64_t,
    float,
    double,
...
using FloatIntAndUIntTypes = ::testing::Types<
    uint32_t,
    int32_t,
    uint64_t,
    int64_t,
...
using TensorFloatingTypes = ::testing::Types<
...
using HighPrecisionTensorFloatingTypes = ::testing::Types<
    fetch::math::Tensor<float>,
    fetch::math::Tensor<double>,
    fetch::math::Tensor<fetch::fixed_point::fp64_t>>;

using TensorIntAndFloatingTypes = ::testing::Types<
    fetch::math::Tensor<int32_t>,
    fetch::math::Tensor<int64_t>,
    fetch::math::Tensor<float>,
    fetch::math::Tensor<double>,
    fetch::math::Tensor<fetch::fixed_point::fp32_t>,
    fetch::math::Tensor<fetch::fixed_point::fp64_t>,
...
using TensorFloatIntAndUIntTypes = ::testing::Types<
    fetch::math::Tensor<int32_t>,
    fetch::math::Tensor<uint32_t>,
    fetch::math::Tensor<int64_t>,
    fetch::math::Tensor<uint64_t>,
    fetch::math::Tensor<float>,
    fetch::math::Tensor<double>,
    fetch::math::Tensor<fetch::fixed_point::fp32_t>,
    fetch::math::Tensor<fetch::fixed_point::fp64_t>,
