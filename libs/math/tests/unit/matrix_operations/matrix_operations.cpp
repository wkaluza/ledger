...
TYPED_TEST(FreeFunctionsTest, Product_OneDimension)
{
  ...
  fetch::math::Product(array1, output);
  EXPECT_NEAR(
      static_cast<double>(output), 0.0, 10.0 * static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, Product_TwoDimension)
{
  ...
  DataType output = fetch::math::Product(array1);
  EXPECT_NEAR(
      static_cast<double>(output), 30.03, 8 * static_cast<double>(function_tolerance<DataType>()));
...
TYPED_TEST(FreeFunctionsTest, PeakToPeak_OneDimension)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output), 21.7, static_cast<double>(function_tolerance<DataType>()));

  array1(3) = fetch::math::Type<DataType>("0.5");
  fetch::math::PeakToPeak(array1, output);
  EXPECT_NEAR(
      static_cast<double>(output), 0.9, static_cast<double>(function_tolerance<DataType>()));

  array1(1) = fetch::math::Type<DataType>("0.1");
  fetch::math::PeakToPeak(array1, output);
  EXPECT_NEAR(
      static_cast<double>(output), 0.6, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, PeakToPeak_TwoDimension)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0)), 38, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1)), 0, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2)), 986, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3)), 21.5, static_cast<double>(function_tolerance<DataType>()));

  TypeParam output2{n_features};
  fetch::math::PeakToPeak(array1, 0, output2);
  EXPECT_NEAR(
      static_cast<double>(output2(0)), 38, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output2(1)), 999.5, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, Sum_OneDimension)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output), 24.2, static_cast<double>(function_tolerance<DataType>()));

  array1(3) = 0;
  fetch::math::Sum(array1, output);
  EXPECT_NEAR(
      static_cast<double>(output), 2.2, static_cast<double>(function_tolerance<DataType>()));
...
TYPED_TEST(FreeFunctionsTest, ReduceSum_axis_0)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 17., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1)),
      1019.5,
...
TYPED_TEST(FreeFunctionsTest, ReduceSum_axis_1)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 4., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0)), 0., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0)),
      1012.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3, 0)), 20.5, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, ReduceSum3D_axis_0)
{
  ...
  // Test values
  EXPECT_NEAR(
      static_cast<double>(output(0, 0, 0)),
      10.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1, 0)),
      26.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 2, 0)),
      42.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 3, 0)),
      58.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 0, 1)),
      74.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1, 1)),
      90.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 2, 1)),
      106.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 3, 1)),
      122.,
      static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, ReduceSum3D_axis_2)
{
  ...
  EXPECT_NEAR(
      ...
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0, 0)),
      20.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0, 0)),
      22.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3, 0, 0)),
      24.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1, 0)),
      ...
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 1, 0)),
      28.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 1, 0)),
      30.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
  ...
  EXPECT_NEAR(
      ...
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 2, 0)),
      36.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 2, 0)),
      38.,
      static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3, 2, 0)),
      40.,
      static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, ReduceMean_axis_0)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 4.25, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1)),
      254.875,
      static_cast<double>(function_tolerance<DataType>()));
...
TYPED_TEST(FreeFunctionsTest, ReduceMean_axis_1)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 2., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0)), 0., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0)), 506., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3, 0)),
      10.25,
      static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, Dot)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 3, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1)), 9, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 2)), 15, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 3)), 21, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0)), 4, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 1)), 14, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 2)), 24, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 3)), 34, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0)), 5, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 1)), 19, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 2)), 33, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 3)), 47, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, DotTranspose)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 12, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1)), 15, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 2)), 18, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 3)), 21, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0)), 16, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 1)), 21, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 2)), 26, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 3)), 31, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0)), 20, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 1)), 27, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 2)), 34, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 3)), 41, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, TransposeDot)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0, 0)), 1, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 1)), 3, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 2)), 5, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(0, 3)), 7, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 0)), 3, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 1)), 13, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 2)), 23, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1, 3)), 33, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 0)), 5, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 1)), 23, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 2)), 41, static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2, 3)), 59, static_cast<double>(function_tolerance<DataType>()));
}
...
TYPED_TEST(FreeFunctionsTest, DynamicStitch)
{
  ...
  EXPECT_NEAR(
      static_cast<double>(output(0)), 7., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(1)), -6., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(2)), 5., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(3)), -4., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(4)), 3., static_cast<double>(function_tolerance<DataType>()));
  EXPECT_NEAR(
      static_cast<double>(output(5)), -2., static_cast<double>(function_tolerance<DataType>()));
}
