...
std::vector<std::string> const numeric_literal_value_templates = {"0{}i32",
                                                                  "12{}u32",
                                                                  "0fp32",
                                                                  "12fp32",
                                                                  "0.0fp32",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ValuesIn(render("E0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseZeroExplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("E+0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseZeroExplicitMinus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("E-0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseZeroImplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseZeroExplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e+0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseZeroExplicitMinus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e-0")));

INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroImplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("E12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroExplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("E+12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroExplicitMinus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("E-12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseNonZeroImplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseNonZeroExplicitPlus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e+12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationLowercaseNonZeroExplicitMinus,
    CoreEtchValidNumericLiteralsTests,
    ValuesIn(render("e-12")));
...
INSTANTIATE_TEST_SUITE_P(
    InvalidNumericLiterals,
    CoreEtchInvalidNumericLiteralsTests,
...
std::vector<std::string> const invalid_fixedpoint_literal_value_templates = {"0{}fp32",
                                                                             "12{}fp32",
                                                                             "0.0{}fp32",
                                                                             "0.00{}fp32",
                                                                             "0.000{}fp32",
...
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseZeroImplicitPlus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseZeroExplicitPlus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E+0")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseZeroExplicitMinus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E-0")));
...
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroImplicitPlus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroExplicitPlus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E+12")));
INSTANTIATE_TEST_SUITE_P(
    ValidNumericLiteralsEngineeringNotationUppercaseNonZeroExplicitMinus,
    CoreEtchInvalidFixedpointLiteralsTests,
    ValuesIn(render_fp("E-12")));
