...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2, 2)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 10, 10)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
    ->Unit(benchmark::kMillisecond);
BENCHMARK_TEMPLATE(
    BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
    ->Unit(benchmark::kMillisecond);
