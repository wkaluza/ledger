...
protected:
      ...
      ConstByteArray const &data = ConstByteArray{})
  {
    ...
    fetch::ledger::ContractContext context{
        nullptr, tx_->contract_address(), nullptr, &storage_adapter, block_number_++};
  ...
  Contract::Result SendAction(TransactionPtr const &tx)
  {
    ...
    // dispatch the transaction to the contract
    fetch::ledger::ContractContext context{
        nullptr, tx->contract_address(), nullptr, &storage_adapter, block_number_++};
    fetch::ledger::ContractContextAttacher raii(*contract_, context);
  ...
  Contract::Status SendQuery(ConstByteArray const &query, Query const &request, Query &response)
  {
    ...
    fetch::ledger::ContractContext context{
        nullptr, fetch::chain::Address{}, nullptr, &storage_adapter, 0};
    fetch::ledger::ContractContextAttacher raii(*contract_, context);
