...
public:
  ...
  damnyouwindows_byte_array::ConstByteArray CurrentHash() override;
  damnyouwindows_byte_array::ConstByteArray LastCommitHash() override;
  bool                       RevertToHash(Hash const &hash, uint64_t index) override;
  damnyouwindows_byte_array::ConstByteArray Commit(uint64_t index) override;
